...
export const SIGNALS: Record<SignalLevel, SignalMeta> = {
  1: {
    level: 1,
    label: "Starkes Kaufsignal",
    short: "Strong Buy",
    description:
      "Höchste Signalstärke auf der Kaufseite. Mehrere Analysefaktoren deuten in dieselbe Richtung.",
    color: "#00E56A",
  ...
  5: {
    level: 5,
    label: "Starkes Verkaufssignal",
    short: "Strong Sell",
    description:
      "Höchste Signalstärke auf der Verkaufsseite. Mehrere Analysefaktoren deuten in dieselbe Richtung.",
    color: "#FF3B3B",
